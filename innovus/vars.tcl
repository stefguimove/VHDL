...
set vars(cwd) {/tp/xph2app/xph2app000/TP_Filtre/asic/par/Template}
...
set vars(execute_string) {/softslin/calibre2013_2_18_13/ixl_cal_2013.2_18.13/pkgs/icv_comp/8.4/bin/tclsh /rech/cime/louahdi/TP_Filtre/asic/par/FFT/SCRIPTS/gen_flow.tcl -m flat -d FF -v 15.2.0 -s . -y none -n init}
...
set vars(hold_func_mode,post_cts_sdc) {/rech/cime/louahdi/TP_Filtre/asic/par/FFT/INPUT_DATA/clock_def.sdc /rech/cime/louahdi/TP_Filtre/asic/par/FFT/INPUT_DATA/clock_uncertainty_postcts.sdc /rech/cime/louahdi/TP_Filtre/asic/par/FFT/INPUT_DATA/constraints_def_best.sdc}
set vars(hold_func_mode,pre_cts_sdc) {/rech/cime/louahdi/TP_Filtre/asic/par/FFT/INPUT_DATA/clock_def.sdc /rech/cime/louahdi/TP_Filtre/asic/par/FFT/INPUT_DATA/clock_uncertainty_prects.sdc /rech/cime/louahdi/TP_Filtre/asic/par/FFT/INPUT_DATA/constraints_def_best.sdc}
...
set vars(netlist) {./INPUT_DATA/filter_io.v}
...
set vars(post_cts_sdc) {/rech/cime/louahdi/TP_Filtre/asic/par/FFT/INPUT_DATA/clock_def.sdc /rech/cime/louahdi/TP_Filtre/asic/par/FFT/INPUT_DATA/clock_uncertainty_postcts.sdc /rech/cime/louahdi/TP_Filtre/asic/par/FFT/INPUT_DATA/constraints_def_worst.sdc}
...
set vars(pre_cts_sdc) {/rech/cime/louahdi/TP_Filtre/asic/par/FFT/INPUT_DATA/clock_def.sdc /rech/cime/louahdi/TP_Filtre/asic/par/FFT/INPUT_DATA/clock_uncertainty_prects.sdc /rech/cime/louahdi/TP_Filtre/asic/par/FFT/INPUT_DATA/constraints_def_worst.sdc}
...
set vars(script_path) {/rech/cime/louahdi/TP_Filtre/asic/par/FFT/SCRIPTS}
set vars(script_root) {/rech/cime/louahdi/TP_Filtre/asic/par/FFT/SCRIPTS}
set vars(seed) {1}
...
set vars(setup_func_mode,post_cts_sdc) {/rech/cime/louahdi/TP_Filtre/asic/par/FFT/INPUT_DATA/clock_def.sdc /rech/cime/louahdi/TP_Filtre/asic/par/FFT/INPUT_DATA/clock_uncertainty_postcts.sdc /rech/cime/louahdi/TP_Filtre/asic/par/FFT/INPUT_DATA/constraints_def_worst.sdc}
set vars(setup_func_mode,pre_cts_sdc) {/rech/cime/louahdi/TP_Filtre/asic/par/FFT/INPUT_DATA/clock_def.sdc /rech/cime/louahdi/TP_Filtre/asic/par/FFT/INPUT_DATA/clock_uncertainty_prects.sdc /rech/cime/louahdi/TP_Filtre/asic/par/FFT/INPUT_DATA/constraints_def_worst.sdc}
