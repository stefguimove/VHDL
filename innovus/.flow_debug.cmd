...
#  Created on Wed Jul 30 13:55:07 2025                
#                                                     
#######################################################
...
set init_verilog {./INPUT_DATA/filter.v ./INPUT_DATA/filter_io.v}
...
init_design
init_design
loadIoFile INPUT_DATA/filter_pads.io
setDrawView place
getIoFlowFlag
setIoFlowFlag 0
floorPlan -site standard -r 1.0 0.70 80 80 80 80
uiSetTool select
getIoFlowFlag
fit
...
addRing -nets {gnd! vdd!} -type core_rings -follow core -layer {top MET1 bottom MET1 left MET2 right MET2} -width {top 20 bottom 20 left 20 right 20} -spacing {top 10 bottom 10 left 10 right 10} -offset {top 1.8 bottom 1.8 left 1.8 right 1.8} -center 1 -extend_corner {} -threshold 0 -jog_distance 0 -snap_wire_center_to_grid None
set sprCreateIeRingOffset 1.0
set sprCreateIeRingThreshold 1.0
set sprCreateIeRingJogDistance 1.0
set sprCreateIeRingLayers {}
...
addStripe -nets {gnd! vdd!} -layer MET2 -direction vertical -width 5 -spacing 0.5 -number_of_sets 2 -start_from left -start_offset 100 -stop_offset 100 -switch_layer_over_obs false -max_same_layer_jog_length 2 -padcore_ring_top_layer_limit MET4 -padcore_ring_bottom_layer_limit MET1 -block_ring_top_layer_limit MET4 -block_ring_bottom_layer_limit MET1 -use_wire_group 0 -snap_wire_center_to_grid None -skip_via_on_pin {  standardcell } -skip_via_on_wire_shape {  noshape }
clearGlobalNets
...
create_ccopt_clock_tree -name clk -source io_CLK/Y -no_skew_group
set_ccopt_property clock_period -pin io_CLK/Y 50
create_ccopt_skew_group -name clk/setup_func_mode -sources io_CLK/Y -auto_sinks
set_ccopt_property include_source_latency -skew_group clk/setup_func_mode true
set_ccopt_property extracted_from_clock_name -skew_group clk/setup_func_mode clk
set_ccopt_property extracted_from_constraint_mode_name -skew_group clk/setup_func_mode setup_func_mode
set_ccopt_property extracted_from_delay_corners -skew_group clk/setup_func_mode corner_max
create_ccopt_skew_group -name clk/hold_func_mode -sources io_CLK/Y -auto_sinks
set_ccopt_property include_source_latency -skew_group clk/hold_func_mode true
set_ccopt_property extracted_from_clock_name -skew_group clk/hold_func_mode clk
set_ccopt_property extracted_from_constraint_mode_name -skew_group clk/hold_func_mode hold_func_mode
set_ccopt_property extracted_from_delay_corners -skew_group clk/hold_func_mode corner_min
